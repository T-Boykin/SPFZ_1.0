...
class SPFZ_MAct
{
  ...
  /* MAIN MENU POSITIONING */
    ...
    public static float[] LAND_MAIN5_BUTTONS_X =  {LMENU_ARCADE_POSX, LMENU_VERSUS_POSX, LMENU_TRAINING_POSX, LMENU_OPTIONS_POSX, LMENU_HELP_POSX},
    ...
    LAND_MAIN5_BUTTONSUP_X = {ZERO, LMENU_VS_TRN_BY_XY, -LMENU_VS_TRN_BY_XY,
  -LMENU_ARC_OPT_HLP_BY, LMENU_ARC_OPT_HLP_BY},
    LAND_MAIN5_BUTTONSUP_Y = {-LMENU_ARC_OPT_HLP_BY, -LMENU_VS_TRN_BY_XY, -LMENU_VS_TRN_BY_XY,
      LMENU_ARC_OPT_HLP_BY, LMENU_ARC_OPT_HLP_BY};
