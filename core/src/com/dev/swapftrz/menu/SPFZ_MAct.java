...
class SPFZ_MAct {
  ...
  public static float[]
    PORT_HOPTS_BUTTONS_X = {PMENU_HOPTS_MS_POSX, PMENU_HOPTS_IG_POSX, PMENU_HOPTS_BCK_POSTX},
    ...
    LAND_MAIN5_SCATTER_X = {0, LMENU_VS_TRN_BY_XY, -LMENU_VS_TRN_BY_XY, -LMENU_ARC_OPT_HLP_BY, LMENU_ARC_OPT_HLP_BY},
  ...
  /*SCALING*/
  PORT_HOPTS_SCALE_X = {PMENU_HOPTS_MS_IG_SCL, PMENU_HOPTS_MS_IG_SCL, PMENU_HOPTS_BCK_SCL},
  ...
  public static float[][][] portPodsXY() {
    ...
    return new float[][][]{{{0, PMENU_POD_TR_Y}, {-PMENU_POD_BR_X1, PMENU_POD_BR_Y1}, {PMENU_POD_TL_X1, PMENU_POD_TL_Y1},
