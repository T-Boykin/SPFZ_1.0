...
public class SPFZEntityFactory {
	...
	protected ComponentFactory compositeComponentFactory, lightComponentFactory, SPFZparticleEffectComponentFactory,
	...
	public SPFZEntityFactory( RayHandler rayHandler, World world, IResourceRetriever rm ) {
		...
		SPFZparticleEffectComponentFactory = new SPFZParticleEffectComponentFactory(rayHandler, world, rm);
	...
	public Entity createEntity(Entity root, ParticleEffectVO vo){
		...
		SPFZparticleEffectComponentFactory.createComponents(root, entity, vo);
